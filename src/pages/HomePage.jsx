  ...
  const testimonials = [
    {
      ...
      quote: "BovBridge helped me save my cow when she fell ill suddenly. The vet I found through the platform arrived within hours and provided excellent care."
    },
    {
      name: "Suresh Patel",
      location: "Gujarat",
          ...
          <div className="md:flex md:items-center md:space-x-16">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="mt-4 text-xl text-earth-700">
                Providing timely medical assistance, home remedies, and preventive care guidance for your cows and buffaloes.
              </p>
