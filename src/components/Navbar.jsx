        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <span className="font-serif text-forest-600 text-xl font-bold">BovBridge</span>
            </Link>
            <div className="hidden md:ml-6 md:flex md:space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute z-10 left-0 mt-2 w-48 origin-top-left bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                  <div className="py-1">
                    ...
                    <Link to="/user/articles" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Articles</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute z-10 left-0 mt-2 w-48 origin-top-left bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                  <div className="py-1">
                    <Link to="/user/search-doctors" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Find Vets</Link>
      ...
      <div className={`md:hidden ${isMenuOpen ? "block" : "hidden"}`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <div id="resources-mobile" className="hidden pl-6 border-l-4 border-transparent">
            ...
            <Link to="/user/articles" className="block py-2 text-sm text-gray-600 hover:text-gray-900" onClick={toggleMenu}>Articles</Link>
          </div>
          ...
          <div id="services-mobile" className="hidden pl-6 border-l-4 border-transparent">
            <Link to="/user/search-doctors" className="block py-2 text-sm text-gray-600 hover:text-gray-900" onClick={toggleMenu}>Find Vets</Link>
