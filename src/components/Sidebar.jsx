...
const Sidebar = ({ userType }) => {
  ...
  const farmerLinks = [
    ...
    { name: "Find Veterinarians", path: "/user/search-doctors", icon: <Search size={20} /> },
    ...
    { 
      ...
      submenu: [
        { name: "Video Tutorials", path: "/user/videos", icon: <Video size={18} /> },
        { name: "Articles", path: "/user/articles", icon: <BookOpen size={18} /> },
      ]
    },
    { 
      ...
      submenu: [
        { name: "Symptoms", path: "/user/symptoms", icon: <AlertCircle size={18} /> },
        { name: "Home Remedies", path: "/user/home-remedies", icon: <Droplet size={18} /> },
  ...
  return (
    <aside className="bg-sidebar w-64 border-r border-sidebar-border hidden md:block overflow-y-auto">
      <div className="h-full flex flex-col">
        <div className="p-6">
          <h1 className="text-xl font-serif font-bold text-forest-600">BovBridge</h1>
